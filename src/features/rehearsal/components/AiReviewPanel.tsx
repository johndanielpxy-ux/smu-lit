...
export function AiReviewPanel({ findings, resolutions, reviewRun, onRun, onOpen, onResolve }: { findings: AiFinding[]; resolutions: Record<string, FindingResolution>; reviewRun: boolean; onRun: () => void; onOpen: (finding: AiFinding) => void; onResolve: (finding: AiFinding, correct: boolean) => void }) {
