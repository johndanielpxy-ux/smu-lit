  ...
  segments: [
    {
      ...
      overlayBeats: [{ atSeconds: 0, overlay: { kind: "extraction", eyebrow: "AI DRAFT · VERIFY BEFORE USE", title: "Renewal facts extracted", facts: [{ label: "Contract value", value: "SGD 42,000" }, { label: "Template", value: "Sales Renewal 2026.2" }, { label: "Governing law", value: "Singapore" }], finding: "No material redline detected" } }],
    },
    {
      ...
      overlayBeats: [{ atSeconds: 0, overlay: { kind: "comparison", eyebrow: "SOURCE CHECK", title: "The AI missed a material change", standardClause: "Liability is capped at 12 months of fees.", submittedClause: "Liability is unlimited, including indirect losses." } }],
    },
    {
      ...
      overlayBeats: [{ atSeconds: 0, overlay: { kind: "decision", eyebrow: "PLAYBOOK APPLIED", title: "Low value is not enough", rule: "Under SGD 50K + no material redline → business approval", conclusion: "Material redline found → shortcut blocked" } }],
    },
    {
      ...
      overlayBeats: [{ atSeconds: 0, overlay: { kind: "route", eyebrow: "HUMAN-VERIFIED ROUTE", title: "Escalated with evidence", route: "Legal review", reason: "Unlimited liability is a material standard-term change", evidence: ["Submitted liability clause", "Material-redline playbook rule"] } }],
    },
  ],
};
