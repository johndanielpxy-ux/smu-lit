...
export function LearningReview({ result, onRepair, onOpenGuide, onOpenSource }: { result: LearningReviewResult; onRepair: (task: RehearsalTask) => void; onOpenGuide: () => void; onOpenSource: (sourceId: string) => void }) {
  ...
  return <main className="review-sheet"><header><span>LAWFLO · Learning review</span><h1>Your review, translated into practice</h1><p>This is a constructive record of what you did and where the workflow supported you.</p></header>
